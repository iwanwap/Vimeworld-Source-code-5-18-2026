...
public class PluginConfiguration$Proxy
extends Proxy
implements PluginConfiguration {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = PluginConfiguration$Proxy.class.getMethod("annotationType", classArray);
    }

    public PluginConfiguration$Proxy(InvocationHandler invocationHandler) {
