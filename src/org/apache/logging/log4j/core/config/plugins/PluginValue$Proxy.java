...
public class PluginValue$Proxy
extends Proxy
implements PluginValue {
    ...
    static {
        ...
        method$0 = PluginValue.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = PluginValue$Proxy.class.getMethod("annotationType", classArray);
    }

    public PluginValue$Proxy(InvocationHandler invocationHandler) {
