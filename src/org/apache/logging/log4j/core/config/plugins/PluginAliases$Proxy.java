...
public class PluginAliases$Proxy
extends Proxy
implements PluginAliases {
    ...
    static {
        ...
        method$0 = PluginAliases.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = PluginAliases$Proxy.class.getMethod("annotationType", classArray);
    }

    public PluginAliases$Proxy(InvocationHandler invocationHandler) {
