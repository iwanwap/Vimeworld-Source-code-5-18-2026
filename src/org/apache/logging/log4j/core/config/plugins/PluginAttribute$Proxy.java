...
public class PluginAttribute$Proxy
extends Proxy
implements PluginAttribute {
    ...
    static {
        ...
        method$0 = PluginAttribute.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = PluginAttribute$Proxy.class.getMethod("annotationType", classArray);
    }

    public PluginAttribute$Proxy(InvocationHandler invocationHandler) {
