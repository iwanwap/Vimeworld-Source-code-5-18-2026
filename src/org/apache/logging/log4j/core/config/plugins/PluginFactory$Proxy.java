...
public class PluginFactory$Proxy
extends Proxy
implements PluginFactory {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = PluginFactory$Proxy.class.getMethod("annotationType", classArray);
    }

    public PluginFactory$Proxy(InvocationHandler invocationHandler) {
