...
public class ConverterKeys$Proxy
extends Proxy
implements ConverterKeys {
    ...
    static {
        ...
        method$0 = ConverterKeys.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = ConverterKeys$Proxy.class.getMethod("annotationType", classArray);
    }

    public ConverterKeys$Proxy(InvocationHandler invocationHandler) {
