...
implements HttpRoutePlanner {
    ...
    protected HttpHost determineProxy(HttpHost target, HttpRequest request, HttpContext context) throws HttpException {
        ...
        if (p2.type() == Proxy.Type.HTTP) {
            ...
            InetSocketAddress isa2 = (InetSocketAddress)p2.address();
            result = new HttpHost(this.getHost(isa2), isa2.getPort());
        }
        return result;
    }

    protected String getHost(InetSocketAddress isa2) {
        return isa2.isUnresolved() ? isa2.getHostName() : isa2.getAddress().getHostAddress();
    }
