...
implements ThreadSafe {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = ThreadSafe$Proxy.class.getMethod("annotationType", classArray);
    }

    public ThreadSafe$Proxy(InvocationHandler invocationHandler) {
