...
public class NotThreadSafe$Proxy
extends Proxy
implements NotThreadSafe {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = NotThreadSafe$Proxy.class.getMethod("annotationType", classArray);
    }

    public NotThreadSafe$Proxy(InvocationHandler invocationHandler) {
