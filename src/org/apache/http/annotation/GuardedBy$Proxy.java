...
public class GuardedBy$Proxy
extends Proxy
implements GuardedBy {
    ...
    static {
        ...
        method$0 = GuardedBy.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = GuardedBy$Proxy.class.getMethod("annotationType", classArray);
    }

    public GuardedBy$Proxy(InvocationHandler invocationHandler) {
