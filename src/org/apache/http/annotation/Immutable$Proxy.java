...
implements Immutable {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = Immutable$Proxy.class.getMethod("annotationType", classArray);
    }

    public Immutable$Proxy(InvocationHandler invocationHandler) {
