...
public class ArrayUtils {
    ...
    public static <T> T[] removeElements(T[] array, T ... values) {
        ...
        for (Map.Entry e2 : occurrences.entrySet()) {
            ...
            v2 = e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v2, found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static byte[] removeElements(byte[] array, byte ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Byte v3 = (Byte)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v3, found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static char[] removeElements(char[] array, char ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Character v3 = (Character)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v3.charValue(), found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static float[] removeElements(float[] array, float ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Float v3 = (Float)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, v3.floatValue(), found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
    ...
    public static double[] removeElements(double[] array, double ... values) {
        ...
        BitSet toRemove = new BitSet();
        for (Map.Entry e2 : occurrences.entrySet()) {
            Double v3 = (Double)e2.getKey();
            int found = 0;
            int ct2 = ((MutableInt)e2.getValue()).intValue();
            for (int i2 = 0; i2 < ct2 && (found = ArrayUtils.indexOf(array, (double)v3, found)) >= 0; ++i2) {
                toRemove.set(found++);
            }
        }
