...
public class TypeUtils {
    ...
    private static boolean equals(WildcardType w2, Type t2) {
        if (t2 instanceof WildcardType) {
            ...
            return TypeUtils.equals(w2.getLowerBounds(), other.getLowerBounds()) && TypeUtils.equals(TypeUtils.getImplicitUpperBounds(w2), TypeUtils.getImplicitUpperBounds(other));
        }
        return true;
    }
