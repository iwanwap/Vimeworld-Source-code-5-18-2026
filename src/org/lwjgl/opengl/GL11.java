...
public final class GL11 {
    ...
    public static void glMapGrid1f(int un2, float u1, float u2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMapGrid1f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglMapGrid1f(un2, u1, u2, function_pointer);
    }

    static native void nglMapGrid1f(int var0, float var1, float var2, long var3);

    public static void glMapGrid1d(int un2, double u1, double u2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMapGrid1d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglMapGrid1d(un2, u1, u2, function_pointer);
    }

    static native void nglMapGrid1d(int var0, double var1, double var3, long var5);

    public static void glMapGrid2f(int un2, float u1, float u2, int vn2, float v1, float v2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMapGrid2f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglMapGrid2f(un2, u1, u2, vn2, v1, v2, function_pointer);
    }

    static native void nglMapGrid2f(int var0, float var1, float var2, int var3, float var4, float var5, long var6);

    public static void glMapGrid2d(int un2, double u1, double u2, int vn2, double v1, double v2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMapGrid2d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglMapGrid2d(un2, u1, u2, vn2, v1, v2, function_pointer);
    }
