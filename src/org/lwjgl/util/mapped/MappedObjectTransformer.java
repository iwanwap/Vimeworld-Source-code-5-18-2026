...
public class MappedObjectTransformer {
    ...
    static byte[] transformMappedObject(byte[] bytecode) {
        ...
        ClassAdapter cv2 = new ClassAdapter((ClassVisitor)cw2){
        ...
        new ClassReader(bytecode).accept((ClassVisitor)cv2, 0);
        return cw2.toByteArray();
    }

    static byte[] transformMappedAPI(String className, byte[] bytecode) {
        TransformationAdapter ta2;
        ...
        TransformationAdapter cv2 = ta2 = new TransformationAdapter((ClassVisitor)cw2, className);
        if (className_to_subtype.containsKey(className)) {
            cv2 = MappedObjectTransformer.getMethodGenAdapter(className, (ClassVisitor)cv2);
        }
        new ClassReader(bytecode).accept((ClassVisitor)cv2, 4);
        if (!ta2.transformed) {
            return bytecode;
        }
        bytecode = cw2.toByteArray();
        if (PRINT_BYTECODE) {
    ...
    private static ClassAdapter getMethodGenAdapter(final String className, ClassVisitor cv2) {
        return new ClassAdapter(cv2){
            ...
            private void generateViewAddressGetter() {
                MethodVisitor mv2 = super.visitMethod(1, MappedObjectTransformer.VIEWADDRESS_METHOD_NAME, "(I)J", null, null);
                mv2.visitCode();
                mv2.visitVarInsn(25, 0);
                mv2.visitFieldInsn(180, MAPPED_OBJECT_JVM, "baseAddress", "J");
                mv2.visitVarInsn(21, 1);
                mv2.visitFieldInsn(178, className, "SIZEOF", "I");
                mv2.visitInsn(104);
                mv2.visitInsn(133);
                mv2.visitInsn(97);
                if (MappedObject.CHECKS) {
                    mv2.visitInsn(92);
                    mv2.visitVarInsn(25, 0);
                    mv2.visitMethodInsn(184, MAPPED_HELPER_JVM, "checkAddress", "(JL" + MAPPED_OBJECT_JVM + ";)V");
                }
                mv2.visitInsn(173);
                mv2.visitMaxs(3, 2);
                mv2.visitEnd();
            ...
            private void generateCapacity() {
                MethodVisitor mv2 = super.visitMethod(1, MappedObjectTransformer.CAPACITY_METHOD_NAME, "()I", null, null);
                mv2.visitCode();
                mv2.visitVarInsn(25, 0);
                mv2.visitMethodInsn(182, MAPPED_OBJECT_JVM, "backingByteBuffer", "()L" + MappedObjectTransformer.jvmClassName(ByteBuffer.class) + ";");
                mv2.visitInsn(89);
                mv2.visitMethodInsn(182, MappedObjectTransformer.jvmClassName(ByteBuffer.class), MappedObjectTransformer.CAPACITY_METHOD_NAME, "()I");
                mv2.visitInsn(95);
                mv2.visitMethodInsn(184, MappedObjectTransformer.jvmClassName(MemoryUtil.class), "getAddress0", "(L" + MappedObjectTransformer.jvmClassName(Buffer.class) + ";)J");
                mv2.visitVarInsn(25, 0);
                mv2.visitFieldInsn(180, MAPPED_OBJECT_JVM, "baseAddress", "J");
                mv2.visitInsn(101);
                mv2.visitInsn(136);
            ...
            private void generateAlignGetter(MappedSubtypeInfo mappedSubtype) {
                MethodVisitor mv2 = super.visitMethod(1, MappedObjectTransformer.ALIGN_METHOD_NAME, "()I", null, null);
                mv2.visitCode();
                MappedObjectTransformer.visitIntNode(mv2, mappedSubtype.sizeof);
                mv2.visitInsn(172);
                mv2.visitMaxs(1, 1);
                mv2.visitEnd();
            }
            ...
            private void generateSizeofGetter() {
                MethodVisitor mv2 = super.visitMethod(1, MappedObjectTransformer.SIZEOF_METHOD_NAME, "()I", null, null);
                mv2.visitCode();
                mv2.visitFieldInsn(178, className, "SIZEOF", "I");
                mv2.visitInsn(172);
                mv2.visitMaxs(1, 1);
            ...
            private void generateNext() {
                MethodVisitor mv2 = super.visitMethod(1, MappedObjectTransformer.NEXT_METHOD_NAME, "()V", null, null);
                mv2.visitCode();
                mv2.visitVarInsn(25, 0);
                mv2.visitInsn(89);
                mv2.visitFieldInsn(180, MAPPED_OBJECT_JVM, "viewAddress", "J");
                mv2.visitFieldInsn(178, className, "SIZEOF", "I");
                mv2.visitInsn(133);
                mv2.visitInsn(97);
                mv2.visitMethodInsn(182, className, "setViewAddress", "(J)V");
                mv2.visitInsn(177);
                mv2.visitMaxs(3, 1);
                mv2.visitEnd();
            }
            ...
            private void generateByteBufferGetter(String fieldName, FieldInfo field) {
                MethodVisitor mv2 = super.visitMethod(9, MappedObjectTransformer.getterName(fieldName), "(L" + className + ";I)" + field.type.getDescriptor(), null, null);
                mv2.visitCode();
                mv2.visitVarInsn(25, 0);
                mv2.visitVarInsn(21, 1);
                mv2.visitMethodInsn(182, className, MappedObjectTransformer.VIEWADDRESS_METHOD_NAME, "(I)J");
                MappedObjectTransformer.visitIntNode(mv2, (int)field.offset);
                mv2.visitInsn(133);
                mv2.visitInsn(97);
                MappedObjectTransformer.visitIntNode(mv2, (int)field.length);
                mv2.visitMethodInsn(184, MAPPED_HELPER_JVM, "newBuffer", "(JI)L" + MappedObjectTransformer.jvmClassName(ByteBuffer.class) + ";");
                mv2.visitInsn(176);
                mv2.visitMaxs(3, 2);
                mv2.visitEnd();
            }
            ...
            private void generateFieldGetter(String fieldName, FieldInfo field) {
                ...
                mv2.visitInsn(133);
                mv2.visitInsn(97);
                mv2.visitMethodInsn(184, MAPPED_HELPER_JVM, field.getAccessType() + "get", "(J)" + field.type.getDescriptor());
                mv2.visitInsn(field.type.getOpcode(172));
                mv2.visitMaxs(3, 2);
                mv2.visitEnd();
            }

            private void generateFieldSetter(String fieldName, FieldInfo field) {
                MethodVisitor mv2 = super.visitMethod(9, MappedObjectTransformer.setterName(fieldName), "(L" + className + ";I" + field.type.getDescriptor() + ")V", null, null);
                mv2.visitCode();
                int load = 0;
                ...
                mv2.visitInsn(133);
                mv2.visitInsn(97);
                mv2.visitMethodInsn(184, MAPPED_HELPER_JVM, field.getAccessType() + "put", "(" + field.type.getDescriptor() + "J)V");
                mv2.visitInsn(177);
                mv2.visitMaxs(4, 4);
                mv2.visitEnd();
            }
    ...
    static int transformMethodCall(InsnList instructions, int i2, Map<AbstractInsnNode, Frame<BasicValue>> frameMap, MethodInsnNode methodInsn, MappedSubtypeInfo mappedType, Map<Integer, MappedSubtypeInfo> arrayVars) {
        switch (methodInsn.getOpcode()) {
            ...
            case 184: {
                ...
                boolean bl2 = isMallocMethod = "malloc".equals(methodInsn.name) && methodInsn.desc.equals("(I)L" + MAPPED_OBJECT_JVM + ";");
    ...
    static int transformArrayAccess(InsnList instructions, int i2, Map<AbstractInsnNode, Frame<BasicValue>> frameMap, VarInsnNode loadInsn, MappedSubtypeInfo mappedSubtype, int var) {
    ...
    static String getOpcodeName(AbstractInsnNode insn) {
        String op2 = OPCODE_TO_NAME.get(insn.getOpcode());
        return INSNTYPE_TO_NAME.get(insn.getType()) + ": " + insn.getOpcode() + (op2 == null ? "" : " [" + OPCODE_TO_NAME.get(insn.getOpcode()) + "]");
    }
    ...
    static void visitIntNode(MethodVisitor mv2, int value) {
        if (value <= 5 && -1 <= value) {
            mv2.visitInsn(2 + value + 1);
        } else if (value >= -128 && value <= 127) {
            mv2.visitIntInsn(16, value);
        } else if (value >= Short.MIN_VALUE && value <= Short.MAX_VALUE) {
            mv2.visitIntInsn(17, value);
        } else {
            mv2.visitLdcInsn((Object)value);
        }
    }
    ...
    private static void printBytecode(byte[] bytecode) {
        ...
        TraceClassVisitor tracer = new TraceClassVisitor((ClassVisitor)new ClassWriter(0), new PrintWriter(sw2));
        new ClassReader(bytecode).accept((ClassVisitor)tracer, 0);
        String dump = sw2.toString();
        LWJGLUtil.log(dump);
    }
    ...
    extends ClassAdapter {
        ...
        TransformationAdapter(ClassVisitor cv2, String className) {
            super(cv2);
            this.className = className;
        }
        ...
        public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
            ...
            if ("<init>".equals(name) && (mappedSubtype = className_to_subtype.get(this.className)) != null) {
                ...
                mv2.visitVarInsn(25, 0);
                mv2.visitMethodInsn(183, MAPPED_OBJECT_JVM, "<init>", "()V");
                mv2.visitInsn(177);
                mv2.visitMaxs(0, 0);
                name = MappedObjectTransformer.VIEW_CONSTRUCTOR_NAME;
            }
            final MethodVisitor mv3 = super.visitMethod(access, name, desc, signature, exceptions);
