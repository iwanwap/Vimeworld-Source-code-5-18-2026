...
public class MappedField$Proxy
extends Proxy
implements MappedField {
    ...
    static {
        ...
        method$0 = MappedField.class.getMethod("byteOffset", classArray);
        classArray = new Class[]{};
        method$1 = MappedField.class.getMethod("byteLength", classArray);
        ...
        classArray = new Class[]{};
        method$5 = MappedField$Proxy.class.getMethod("annotationType", classArray);
    }

    public MappedField$Proxy(InvocationHandler invocationHandler) {
        super(invocationHandler);
    }

    @Override
    public long byteOffset() {
        return (Long)this.h.invoke(this, method$0, null);
    }

    @Override
    public long byteLength() {
        return (Long)this.h.invoke(this, method$1, null);
    }
