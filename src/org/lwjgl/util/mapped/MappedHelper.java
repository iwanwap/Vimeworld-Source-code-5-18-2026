...
public class MappedHelper {
    public static void setup(MappedObject mo2, ByteBuffer buffer, int align, int sizeof) {
        if (LWJGLUtil.CHECKS && mo2.baseAddress != 0L) {
        ...
        mo2.baseAddress = mo2.viewAddress = addr;
    }
