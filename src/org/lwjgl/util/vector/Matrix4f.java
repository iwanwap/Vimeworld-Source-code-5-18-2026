...
implements Serializable {
    ...
    public static Matrix4f rotate(float angle, Vector3f axis, Matrix4f src, Matrix4f dest) {
        ...
        float xy2 = axis.x * axis.y;
        float yz2 = axis.y * axis.z;
        float xz2 = axis.x * axis.z;
        float xs2 = axis.x * s2;
        float ys2 = axis.y * s2;
        float zs2 = axis.z * s2;
        float f00 = axis.x * axis.x * oneminusc + c2;
        float f01 = xy2 * oneminusc + zs2;
        float f02 = xz2 * oneminusc - ys2;
        float f10 = xy2 * oneminusc - zs2;
        float f11 = axis.y * axis.y * oneminusc + c2;
        float f12 = yz2 * oneminusc + xs2;
        float f20 = xz2 * oneminusc + ys2;
        float f21 = yz2 * oneminusc - xs2;
