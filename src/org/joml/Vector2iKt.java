...
public final class Vector2iKt {
    ...
    @NotNull
    public static final Vector2i plus(@NotNull Vector2ic $this$plus, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$plus, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = $this$plus.add(v2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"add(v, Vector2i())");
        return vector2i;
    }

    public static final void plusAssign(@NotNull Vector2i $this$plusAssign, @NotNull Vector2ic v2) {
    ...
    @NotNull
    public static final Vector2i minus(@NotNull Vector2ic $this$minus, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$minus, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = $this$minus.sub(v2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"sub(v, Vector2i())");
        return vector2i;
    }

    public static final void minusAssign(@NotNull Vector2i $this$minusAssign, @NotNull Vector2ic v2) {
    ...
    @NotNull
    public static final Vector2i times(@NotNull Vector2ic $this$times, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$times, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = $this$times.mul(v2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"mul(v, Vector2i())");
        return vector2i;
    }

    @NotNull
    public static final Vector2i times(@NotNull Vector2ic $this$times, int s2) {
        Intrinsics.checkNotNullParameter((Object)$this$times, (String)"<this>");
        Vector2i vector2i = $this$times.mul(s2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"mul(s, Vector2i())");
        return vector2i;
    }

    public static final void timesAssign(@NotNull Vector2i $this$timesAssign, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$timesAssign, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        $this$timesAssign.mul(v2);
    }

    public static final void timesAssign(@NotNull Vector2i $this$timesAssign, int s2) {
        Intrinsics.checkNotNullParameter((Object)$this$timesAssign, (String)"<this>");
        $this$timesAssign.mul(s2);
    }

    @NotNull
    public static final Vector2i div(@NotNull Vector2ic $this$div, float s2) {
        Intrinsics.checkNotNullParameter((Object)$this$div, (String)"<this>");
        Vector2i vector2i = $this$div.div(s2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"div(s, Vector2i())");
        return vector2i;
    }

    @NotNull
    public static final Vector2i div(@NotNull Vector2ic $this$div, int s2) {
        Intrinsics.checkNotNullParameter((Object)$this$div, (String)"<this>");
        Vector2i vector2i = $this$div.div(s2, new Vector2i());
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"div(s, Vector2i())");
        return vector2i;
    ...
    public static final void divAssign(@NotNull Vector2i $this$divAssign, float s2) {
        Intrinsics.checkNotNullParameter((Object)$this$divAssign, (String)"<this>");
        $this$divAssign.div(s2);
    }

    public static final void divAssign(@NotNull Vector2i $this$divAssign, int s2) {
        Intrinsics.checkNotNullParameter((Object)$this$divAssign, (String)"<this>");
        $this$divAssign.div(s2);
    }
    ...
    public static final double distance(@NotNull Vector2ic $this$distance, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$distance, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        return $this$distance.distance(v2);
    }

    public static final long distanceSquared(@NotNull Vector2ic $this$distanceSquared, @NotNull Vector2ic v2) {
        Intrinsics.checkNotNullParameter((Object)$this$distanceSquared, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        return $this$distanceSquared.distanceSquared(v2);
    }

    public static final long gridDistance(@NotNull Vector2ic $this$gridDistance, @NotNull Vector2ic v2) {
    ...
    @NotNull
    public static final Vector2i getVector2i(@NotNull ByteBuffer $this$getVector2i, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$getVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = v2.set($this$getVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"v.set(this)");
        return vector2i;
    }

    @NotNull
    public static final Vector2i getVector2i(@NotNull ByteBuffer $this$getVector2i, int index, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$getVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = v2.set(index, $this$getVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"v.set(index, this)");
        return vector2i;
    }

    @NotNull
    public static final ByteBuffer putVector2i(@NotNull ByteBuffer $this$putVector2i, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$putVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        ByteBuffer byteBuffer = v2.get($this$putVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)byteBuffer, (String)"v.get(this)");
        return byteBuffer;
    }

    @NotNull
    public static final ByteBuffer putVector2i(@NotNull ByteBuffer $this$putVector2i, int index, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$putVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        ByteBuffer byteBuffer = v2.get(index, $this$putVector2i);
    ...
    @NotNull
    public static final Vector2i getVector2i(@NotNull IntBuffer $this$getVector2i, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$getVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = v2.set($this$getVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"v.set(this)");
    ...
    @NotNull
    public static final Vector2i getVector2i(@NotNull IntBuffer $this$getVector2i, int index, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$getVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        Vector2i vector2i = v2.set(index, $this$getVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)vector2i, (String)"v.set(index, this)");
    ...
    @NotNull
    public static final IntBuffer putVector2i(@NotNull IntBuffer $this$putVector2i, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$putVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        IntBuffer intBuffer = v2.get($this$putVector2i);
        Intrinsics.checkNotNullExpressionValue((Object)intBuffer, (String)"v.get(this)");
        return intBuffer;
    }

    @NotNull
    public static final IntBuffer putVector2i(@NotNull IntBuffer $this$putVector2i, int index, @NotNull Vector2i v2) {
        Intrinsics.checkNotNullParameter((Object)$this$putVector2i, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)v2, (String)"v");
        IntBuffer intBuffer = v2.get(index, $this$putVector2i);
