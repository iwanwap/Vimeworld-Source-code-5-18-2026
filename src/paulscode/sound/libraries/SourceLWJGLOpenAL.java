...
extends Source {
    ...
    private void calculateDistance() {
        if (this.listenerPosition != null) {
            double dX2 = this.position.x - this.listenerPosition.get(0);
            double dY2 = this.position.y - this.listenerPosition.get(1);
            double dZ2 = this.position.z - this.listenerPosition.get(2);
            this.distanceFromListener = (float)Math.sqrt(dX2 * dX2 + dY2 * dY2 + dZ2 * dZ2);
        }
    }
