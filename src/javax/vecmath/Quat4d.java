...
implements Serializable {
    ...
    public final void mulInverse(Quat4d q1, Quat4d q2) {
        double n2 = this.norm();
        n2 = n2 == 0.0 ? n2 : 1.0 / n2;
        this.set((q1.x * q2.w - q1.w * q2.x - q1.y * q2.z + q1.z * q2.y) * n2, (q1.y * q2.w - q1.w * q2.y - q1.z * q2.x + q1.x * q2.z) * n2, (q1.z * q2.w - q1.w * q2.z - q1.x * q2.y + q1.y * q2.x) * n2, (q1.w * q2.w + q1.x * q2.x + q1.y * q2.y + q1.z * q2.z) * n2);
    }

    public final void mulInverse(Quat4d q1) {
        double n2 = this.norm();
        n2 = n2 == 0.0 ? n2 : 1.0 / n2;
        this.set((this.x * q1.w - this.w * q1.x - this.y * q1.z + this.z * q1.y) * n2, (this.y * q1.w - this.w * q1.y - this.z * q1.x + this.x * q1.z) * n2, (this.z * q1.w - this.w * q1.z - this.x * q1.y + this.y * q1.x) * n2, (this.w * q1.w + this.x * q1.x + this.y * q1.y + this.z * q1.z) * n2);
    }
    ...
    public final void set(AxisAngle4f a1) {
        ...
        double s2 = Math.sin(0.5 * (double)a1.angle) / n2;
        this.x *= s2;
        this.y *= s2;
        this.z *= s2;
    ...
    public final void set(AxisAngle4d a1) {
        ...
        this.z = a1.z;
        double n2 = Math.sqrt(this.x * this.x + this.y * this.y + this.z * this.z);
        double s2 = Math.sin(0.5 * a1.angle) / n2;
        this.x *= s2;
        this.y *= s2;
        this.z *= s2;
    ...
    public final void interpolate(Quat4d q1, double alpha) {
        ...
        double z1 = q1.z / n1;
        double w1 = q1.w / n1;
        double t2 = this.x * x1 + this.y * y1 + this.z * z1 + this.w * w1;
        if (1.0 <= Math.abs(t2)) {
            return;
        }
        ...
        this.x = s2 * this.x + t2 * x1;
        this.y = s2 * this.y + t2 * y1;
        this.z = s2 * this.z + t2 * z1;
        this.w = s2 * this.w + t2 * w1;
    }
