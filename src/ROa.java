...
public final class ROa {
    ...
    static {
        ...
        r = "hide-health";
        Ha = "linear_velocity";
        d = "resin_brick_slab_double";
        Ga = "ofShowFps:";
        v = "goldenRail(?:_powered)?";
        A = "DownfallBlock";
        c = "expLevel";
        g = "VC: Update muted {}";
        ...
        P = "optifine_part";
        O = "effectEnabled";
        z = "of.options.framerateLimit.vsync";
        N = "skeleton/wither_skeleton";
        n = "yaw";
        Q = "Dimension";
        T = "inflate error";
