        ...
        try {
            ...
            try {
                for (ByteBuf buf : certs) {
                    certChain.add(cf2.generateCertificate(new ByteBufInputStream(buf)));
                }
            }
            finally {
                for (ByteBuf buf : certs) {
            ...
            ks2.setKeyEntry("key", key, keyPasswordChars, certChain.toArray(new Certificate[certChain.size()]));
