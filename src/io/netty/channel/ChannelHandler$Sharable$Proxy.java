...
public class ChannelHandler$Sharable$Proxy
extends Proxy
implements ChannelHandler.Sharable {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = ChannelHandler$Sharable$Proxy.class.getMethod("annotationType", classArray);
    }

    public ChannelHandler$Sharable$Proxy(InvocationHandler invocationHandler) {
