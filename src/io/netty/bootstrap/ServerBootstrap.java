    ...
    void init(Channel channel) throws Exception {
        ...
        p2.addLast(new ChannelInitializer<Channel>(){
            ...
            public void initChannel(Channel ch2) throws Exception {
                ch2.pipeline().addLast(new ServerBootstrapAcceptor(currentChildGroup, currentChildHandler, currentChildOptions, currentChildAttrs));
            }
        });
    }
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) {
            ...
            for (Map.Entry<ChannelOption<?>, Object> entry : this.childOptions) {
                try {
                    ...
                    logger.warn("Failed to set a channel option: " + child, t2);
                }
            }
            ...
            try {
                ...
                ServerBootstrapAcceptor.forceClose(child, t3);
            }
        }
