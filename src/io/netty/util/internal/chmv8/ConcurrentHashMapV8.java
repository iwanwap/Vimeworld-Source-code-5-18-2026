...
Serializable {
    ...
    public KeySetView<K, V> keySet() {
        KeySetView<K, V> ks2 = this.keySet;
        return ks2 != null ? ks2 : (this.keySet = new KeySetView(this, null));
    }
    ...
    public boolean equals(Object o2) {
        if (o2 != this) {
            ...
            for (Map.Entry e2 : m2.entrySet()) {
                V v3;
                Object mv2;
                Object mk2 = e2.getKey();
                if (mk2 != null && (mv2 = e2.getValue()) != null && (v3 = this.get(mk2)) != null && (mv2 == v3 || mv2.equals(v3))) continue;
                return false;
            }
        }
        return true;
    ...
    private void readObject(ObjectInputStream s2) throws IOException, ClassNotFoundException {
        ...
        if (size == 0L) {
            ...
            if (size >= 0x20000000L) {
                ...
                int sz2 = (int)size;
                n2 = ConcurrentHashMapV8.tableSizeFor(sz2 + (sz2 >>> 1) + 1);
            }
            ...
            while (p2 != null) {
                ...
                if (first == null) {
                    ...
                    if (first.hash < 0) {
                        ...
                        while (q2 != null) {
                            Object qk2;
                            if (q2.hash == h2 && ((qk2 = q2.key) == k3 || qk2 != null && k3.equals(qk2))) {
                                insertAtFront = false;
                                break;
                            }
                            ++binCount;
    ...
    Serializable {
        ...
        public final Object[] toArray() {
            long sz2 = this.map.mappingCount();
            if (sz2 > 0x7FFFFFF7L) {
    ...
    extends Node<K, V> {
        ...
        final boolean removeTreeNode(TreeNode<K, V> p2) {
            ...
            try {
                ...
                TreeNode pl2 = p2.left;
                TreeNode pr2 = p2.right;
                if (pl2 != null && pr2 != null) {
                    TreeNode sl2;
                    TreeNode s2 = pr2;
                    ...
                    replacement = pl2 != null ? pl2 : (pr2 != null ? pr2 : p2);
                }
                if (replacement != p2) {
        ...
        static <K, V> boolean checkInvariants(TreeNode<K, V> t2) {
            ...
            TreeNode tl2 = t2.left;
            TreeNode tr2 = t2.right;
            TreeNode tb2 = t2.prev;
            ...
            if (tl2 != null && (tl2.parent != t2 || tl2.hash > t2.hash)) {
                return false;
            }
            if (tr2 != null && (tr2.parent != t2 || tr2.hash < t2.hash)) {
                return false;
            }
            if (t2.red && tl2 != null && tl2.red && tr2 != null && tr2.red) {
                return false;
            }
            if (tl2 != null && !TreeBin.checkInvariants(tl2)) {
                return false;
            }
