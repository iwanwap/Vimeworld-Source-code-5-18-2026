...
extends RealmsScreen {
    ...
    private static LoadingCache<String, String> activitiesNameCache = CacheBuilder.newBuilder().build(new CacheLoader<String, String>(){
        ...
        public String load(String uuid) throws Exception {
            String name = Realms.uuidToName((String)uuid);
            if (name == null) {
    ...
    public void init() {
        ...
        this.buttonsAdd(RealmsActivityScreen.newButton((int)this.BUTTON_BACK_ID, (int)(this.width() / 2 - 100), (int)(this.height() - 30), (int)200, (int)20, (String)RealmsActivityScreen.getLocalizedString((String)"gui.back")));
    }
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        if (this.activityMap != null && this.activityMap.size() > 0) {
            ...
            t2.vertex((double)this.activityPoint, (double)(this.height() - 40), 0.0).color(128, 128, 128, 255).endVertex();
            t2.vertex((double)(this.activityPoint + 1), (double)(this.height() - 40), 0.0).color(128, 128, 128, 255).endVertex();
            t2.vertex((double)(this.activityPoint + 1), 30.0, 0.0).color(128, 128, 128, 255).endVertex();
            t2.vertex((double)this.activityPoint, 30.0, 0.0).color(128, 128, 128, 255).endVertex();
            t2.end();
            GL11.glEnable(3553);
            for (Day day : this.dayList) {
                ...
                GL11.glDisable(3553);
                t2.begin(7, RealmsDefaultVertexFormat.POSITION_COLOR);
                t2.vertex((double)(this.activityPoint + daysIndex * this.dayWidth), (double)(this.height() - 40), 0.0).color(128, 128, 128, 255).endVertex();
                t2.vertex((double)(this.activityPoint + daysIndex * this.dayWidth + 1), (double)(this.height() - 40), 0.0).color(128, 128, 128, 255).endVertex();
                t2.vertex((double)(this.activityPoint + daysIndex * this.dayWidth + 1), 30.0, 0.0).color(128, 128, 128, 255).endVertex();
                t2.vertex((double)(this.activityPoint + daysIndex * this.dayWidth), 30.0, 0.0).color(128, 128, 128, 255).endVertex();
                t2.end();
                GL11.glEnable(3553);
            }
        }
        super.render(xm2, ym2, a2);
        this.drawCenteredString(RealmsActivityScreen.getLocalizedString((String)"mco.activity.title"), this.width() / 2, 10, 0xFFFFFF);
        if (this.toolTip != null) {
            this.renderMousehoverTooltip(this.toolTip, xm2, ym2);
        }
        if (this.noActivity.booleanValue()) {
            this.drawCenteredString(RealmsActivityScreen.getLocalizedString((String)"mco.activity.noactivity", (Object[])new Object[]{TimeUnit.DAYS.convert(this.periodInMillis, TimeUnit.MILLISECONDS)}), this.width() / 2, this.height() / 2 - 20, 0xFFFFFF);
        }
    }
    ...
    protected void renderMousehoverTooltip(String msg, int x2, int y2) {
        ...
        for (String s3 : msg.split("\n")) {
            ...
            this.fontDrawShadow(s3, rx2, ry2 + index, -1);
            index += 10;
        }
    }
    ...
    extends RealmsScrolledSelectionList {
        ...
        protected void renderItem(int i2, int x2, int y2, int h2, Tezzelator t2, int mouseX, int mouseY) {
            if (RealmsActivityScreen.this.activityMap != null && RealmsActivityScreen.this.activityMap.size() > i2) {
                ...
                GL11.glDisable(3553);
                t2.begin(7, RealmsDefaultVertexFormat.POSITION_COLOR);
                t2.vertex((double)(RealmsActivityScreen.this.activityPoint - 8), (double)y2 + 6.5, 0.0).color(r2, g2, b2, 255).endVertex();
                t2.vertex((double)(RealmsActivityScreen.this.activityPoint - 3), (double)y2 + 6.5, 0.0).color(r2, g2, b2, 255).endVertex();
                t2.vertex((double)(RealmsActivityScreen.this.activityPoint - 3), (double)y2 + 1.5, 0.0).color(r2, g2, b2, 255).endVertex();
                t2.vertex((double)(RealmsActivityScreen.this.activityPoint - 8), (double)y2 + 1.5, 0.0).color(r2, g2, b2, 255).endVertex();
                t2.end();
                GL11.glEnable(3553);
                RealmsScreen.bindFace((String)((ActivityRow)((RealmsActivityScreen)RealmsActivityScreen.this).activityMap.get((int)i2)).uuid, (String)((ActivityRow)((RealmsActivityScreen)RealmsActivityScreen.this).activityMap.get((int)i2)).name);
                GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
                RealmsScreen.blit((int)10, (int)y2, (float)8.0f, (float)8.0f, (int)8, (int)8, (int)8, (int)8, (float)64.0f, (float)64.0f);
                RealmsScreen.blit((int)10, (int)y2, (float)40.0f, (float)8.0f, (int)8, (int)8, (int)8, (int)8, (float)64.0f, (float)64.0f);
