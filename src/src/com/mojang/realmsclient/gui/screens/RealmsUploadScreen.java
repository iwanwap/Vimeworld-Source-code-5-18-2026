...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.buttonsClear();
        this.backButton = RealmsUploadScreen.newButton((int)1, (int)(this.width() / 2 - 100), (int)(this.height() - 42), (int)200, (int)20, (String)RealmsUploadScreen.getLocalizedString((String)"gui.back"));
        this.cancelButton = RealmsUploadScreen.newButton((int)0, (int)(this.width() / 2 - 100), (int)(this.height() - 42), (int)200, (int)20, (String)RealmsUploadScreen.getLocalizedString((String)"gui.cancel"));
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        if (!this.uploadFinished && this.uploadStatus.bytesWritten != 0L && this.uploadStatus.bytesWritten.longValue() == this.uploadStatus.totalBytes.longValue()) {
            this.status = RealmsUploadScreen.getLocalizedString((String)"mco.upload.verifying");
        }
    ...
    private void uploadCancelled(long worldId) {
        this.status = RealmsUploadScreen.getLocalizedString((String)"mco.upload.cancelled");
