...
extends RealmsScreen {
    ...
    public RealmsSelectWorldTemplateScreen(RealmsScreenWithCallback<WorldTemplate> lastScreen, WorldTemplate selectedWorldTemplate, boolean isMiniGame) {
        ...
        this.title = isMiniGame ? RealmsSelectWorldTemplateScreen.getLocalizedString((String)"mco.template.title.minigame") : RealmsSelectWorldTemplateScreen.getLocalizedString((String)"mco.template.title");
    }
    ...
    public void init() {
        ...
        this.buttonsAdd(RealmsSelectWorldTemplateScreen.newButton((int)0, (int)(this.width() / 2 + 6), (int)(this.height() - 32), (int)153, (int)20, (String)(this.isMiniGame ? RealmsSelectWorldTemplateScreen.getLocalizedString((String)"gui.cancel") : RealmsSelectWorldTemplateScreen.getLocalizedString((String)"gui.back"))));
        this.selectButton = RealmsSelectWorldTemplateScreen.newButton((int)1, (int)(this.width() / 2 - 154), (int)(this.height() - 32), (int)153, (int)20, (String)RealmsSelectWorldTemplateScreen.getLocalizedString((String)"mco.template.button.select"));
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        if (this.displayWarning) {
            this.drawCenteredString(RealmsSelectWorldTemplateScreen.getLocalizedString((String)"mco.minigame.world.info1"), this.width() / 2, RealmsConstants.row(-1), 0xA0A0A0);
            this.drawCenteredString(RealmsSelectWorldTemplateScreen.getLocalizedString((String)"mco.minigame.world.info2"), this.width() / 2, RealmsConstants.row(0), 0xA0A0A0);
        }
    ...
    extends RealmsClickableScrolledSelectionList {
        ...
        private void drawImage(int x2, int y2, int xm2, int ym2, WorldTemplate worldTemplate) {
            ...
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            RealmsScreen.blit((int)(x2 + 1), (int)(y2 + 1), (float)0.0f, (float)0.0f, (int)38, (int)38, (float)38.0f, (float)38.0f);
            RealmsScreen.bind((String)RealmsSelectWorldTemplateScreen.SLOT_FRAME_LOCATION);
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            RealmsScreen.blit((int)x2, (int)y2, (float)0.0f, (float)0.0f, (int)40, (int)40, (float)40.0f, (float)40.0f);
        }
        ...
        private void drawIcons(int x2, int y2, int xm2, int ym2, String link, String trailerLink, String recommendedPlayers) {
            ...
            if (!link.equals("")) {
                RealmsScreen.bind((String)RealmsSelectWorldTemplateScreen.LINK_ICON);
                GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
                GL11.glPushMatrix();
                GL11.glScalef(1.0f, 1.0f, 1.0f);
                RealmsScreen.blit((int)(x2 + offset), (int)y2, (float)(linkHovered ? 15.0f : 0.0f), (float)0.0f, (int)15, (int)15, (float)30.0f, (float)15.0f);
                GL11.glPopMatrix();
            }
            if (!trailerLink.equals("")) {
                RealmsScreen.bind((String)RealmsSelectWorldTemplateScreen.TRAILER_ICON);
                GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
                GL11.glPushMatrix();
                GL11.glScalef(1.0f, 1.0f, 1.0f);
                RealmsScreen.blit((int)(x2 + offset + (link.equals("") ? 0 : 17)), (int)y2, (float)(trailerHovered ? 15.0f : 0.0f), (float)0.0f, (int)15, (int)15, (float)30.0f, (float)15.0f);
                GL11.glPopMatrix();
            }
            if (linkHovered && !link.equals("")) {
                RealmsSelectWorldTemplateScreen.this.toolTip = RealmsScreen.getLocalizedString((String)"mco.template.info.tooltip");
                RealmsSelectWorldTemplateScreen.this.currentLink = link;
            } else if (trailerHovered && !trailerLink.equals("")) {
                RealmsSelectWorldTemplateScreen.this.toolTip = RealmsScreen.getLocalizedString((String)"mco.template.trailer.tooltip");
