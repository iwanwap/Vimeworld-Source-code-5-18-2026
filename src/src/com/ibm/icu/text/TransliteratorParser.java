...
class TransliteratorParser {
    ...
    private void checkVariableRange(int ch2, String rule, int start) {
        if (ch2 >= this.curData.variablesBase && ch2 < this.variableLimit) {
    ...
    private void appendVariableDef(String name, StringBuffer buf) {
        char[] ch2 = this.variableNames.get(name);
        if (ch2 == null) {
    ...
    implements SymbolTable {
        ...
        public UnicodeMatcher lookupMatcher(int ch2) {
            int i2 = ch2 - ((TransliteratorParser)TransliteratorParser.this).curData.variablesBase;
        ...
        public boolean isMatcher(int ch2) {
            int i2 = ch2 - ((TransliteratorParser)TransliteratorParser.this).curData.variablesBase;
            if (i2 >= 0 && i2 < TransliteratorParser.this.variablesVector.size()) {
        ...
        public boolean isReplacer(int ch2) {
            int i2 = ch2 - ((TransliteratorParser)TransliteratorParser.this).curData.variablesBase;
            if (i2 >= 0 && i2 < TransliteratorParser.this.variablesVector.size()) {
