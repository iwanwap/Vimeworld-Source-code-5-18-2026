...
extends Calendar {
        ...
        switch (field) {
            case 1: {
                ...
                while (lowGood + 1 < highBad) {
                    ...
                    cal.set(1, y2);
                    if (cal.get(1) == y2 && cal.get(0) == era2) {
                        lowGood = y2;
                        continue;
                    }
                    highBad = y2;
    ...
    protected int handleGetExtendedYear() {
        int era2;
        int year = this.newerField(19, 1) == 19 ? this.internalGet(19, 1970) : ((era2 = this.internalGet(0, 1)) == 0 ? 1 - this.internalGet(1, 1) : this.internalGet(1, 1970));
        return year;
    }
