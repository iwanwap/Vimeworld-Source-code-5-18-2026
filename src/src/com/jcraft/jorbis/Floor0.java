...
extends FuncFloor {
    ...
    static void lsp_to_lpc(float[] lsp, float[] lpc, int m2) {
        ...
        float[] Ae2 = new float[m22 + 1];
        float[] Ao2 = new float[m22 + 1];
        float[] Be2 = new float[m22];
        float[] Bo2 = new float[m22];
        for (i2 = 0; i2 < m22; ++i2) {
        ...
        for (i2 = 1; i2 < m2 + 1; ++i2) {
            ...
            float A2 = 0.0f;
            for (j2 = 0; j2 < m22; ++j2) {
                float temp = O2[j2] * Ao2[j2] + Ae2[j2];
                Ae2[j2] = Ao2[j2];
                Ao2[j2] = A2;
                A2 += temp;
                temp = E2[j2] * Bo2[j2] + Be2[j2];
                Be2[j2] = Bo2[j2];
                Bo2[j2] = B2;
                B2 += temp;
            }
            lpc[i2 - 1] = (A2 + Ao2[j2] + B2 - Ae2[j2]) / 2.0f;
            Ao2[j2] = A2;
            Ae2[j2] = B2;
        }
    }
