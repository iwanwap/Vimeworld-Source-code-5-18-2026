...
public class ExperimentalApi$Proxy
extends Proxy
implements ExperimentalApi {
    ...
    static {
        ...
        method$0 = ExperimentalApi.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = ExperimentalApi$Proxy.class.getMethod("annotationType", classArray);
    }

    public ExperimentalApi$Proxy(InvocationHandler invocationHandler) {
