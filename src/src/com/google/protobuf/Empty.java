...
implements EmptyOrBuilder {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO: {
                Object[] objects = null;
                String info = "\u0000\u0000";
                return Empty.newMessageInfo(DEFAULT_INSTANCE, info, objects);
            }
            ...
            case GET_PARSER: {
                ...
                Class<Empty> clazz = Empty.class;
                synchronized (Empty.class) {
                    parser = PARSER;
                    if (parser != null) return parser;
                    PARSER = parser = new GeneratedMessageLite.DefaultInstanceBasedParser<Empty>(DEFAULT_INSTANCE);
    ...
    static {
        ...
        DEFAULT_INSTANCE = defaultInstance = new Empty();
