...
public class CheckReturnValue$Proxy
extends Proxy
implements CheckReturnValue {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = CheckReturnValue$Proxy.class.getMethod("annotationType", classArray);
    }

    public CheckReturnValue$Proxy(InvocationHandler invocationHandler) {
