...
public enum FieldType {
    ...
    private FieldType(int id2, Collection collection, JavaType javaType) {
        this.id = id2;
        ...
        block0: while (clazz != List.class) {
            ...
            if (genericType instanceof ParameterizedType) {
                ...
                for (int i2 = 0; i2 < superArgs.length; ++i2) {
                    ...
                    for (int j2 = 0; j2 < clazzParams.length; ++j2) {
                        Type realType;
                        if (superArg != clazzParams[j2]) continue;
                        superArgs[i2] = realType = realTypes[j2];
    ...
    static {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            FieldType type;
            FieldType.VALUES[type.id] = type = fieldTypeArray[i2];
        }
    }
