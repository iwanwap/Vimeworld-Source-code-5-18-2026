...
implements Subscribe {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = Subscribe$Proxy.class.getMethod("annotationType", classArray);
    }

    public Subscribe$Proxy(InvocationHandler invocationHandler) {
