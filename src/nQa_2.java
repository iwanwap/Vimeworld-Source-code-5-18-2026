...
public final class nQa_2 {
    ...
    static {
        ...
        N = "Right.Right45";
        R = "Shape10";
        Ha = "GL12.GL_UNSIGNED_INT_8_8_8_8";
        D = "allowAnyShaders";
        ...
        X = "deepslateCoalOre";
        a = "diamond";
        A = "Towards positive Z";
        x = "GL11.GL_INTENSITY16";
        t = "data_";
        G = "%$1s";
        V = "disable-tab";
        Ka = "Content-Length";
        P = "waxedChiseledCopper";
        S = "oxidized_cut_copper_slab_double";
        Y = "bone_block";
