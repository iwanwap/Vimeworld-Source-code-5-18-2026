...
extends Calendar {
    ...
    public ChineseCalendar(int era2, int year, int month, int isLeapMonth, int date) {
        this(era2, year, month, isLeapMonth, 0, 0, 0);
    }

    public ChineseCalendar(int era2, int year, int month, int isLeapMonth, int date, int hour, int minute, int second) {
        this(TimeZone.getDefault(), ULocale.getDefault(ULocale.Category.FORMAT), -2636, CHINA_ZONE);
        this.set(14, 0);
        this.set(0, era2);
        this.set(1, year);
