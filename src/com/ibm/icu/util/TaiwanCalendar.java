...
extends GregorianCalendar {
    ...
    protected int handleGetExtendedYear() {
        int era2;
        int year = 1970;
        year = this.newerField(19, 1) == 19 && this.newerField(19, 0) == 19 ? this.internalGet(19, 1970) : ((era2 = this.internalGet(0, 1)) == 1 ? this.internalGet(1, 1) + 1911 : 1 - this.internalGet(1, 1) + 1911);
        return year;
    }
