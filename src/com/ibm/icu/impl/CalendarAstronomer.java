...
public class CalendarAstronomer {
    ...
    public double getGreenwichSidereal() {
        if (this.siderealTime == Double.MIN_VALUE) {
            double UT2 = CalendarAstronomer.normalize((double)this.time / 3600000.0, 24.0);
            this.siderealTime = CalendarAstronomer.normalize(this.getSiderealOffset() + UT2 * 1.002737909, 24.0);
        }
    ...
    private double getSiderealOffset() {
        if (this.siderealT0 == Double.MIN_VALUE) {
            double JD2 = Math.floor(this.getJulianDay() - 0.5) + 0.5;
            double S2 = JD2 - 2451545.0;
            double T2 = S2 / 36525.0;
