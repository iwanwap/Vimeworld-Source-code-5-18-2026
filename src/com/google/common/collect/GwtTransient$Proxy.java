...
public class GwtTransient$Proxy
extends Proxy
implements GwtTransient {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = GwtTransient$Proxy.class.getMethod("annotationType", classArray);
    }

    public GwtTransient$Proxy(InvocationHandler invocationHandler) {
