...
public class VisibleForTesting$Proxy
extends Proxy
implements VisibleForTesting {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = VisibleForTesting$Proxy.class.getMethod("annotationType", classArray);
    }

    public VisibleForTesting$Proxy(InvocationHandler invocationHandler) {
