...
implements Until {
    ...
    static {
        ...
        method$0 = Until.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = Until$Proxy.class.getMethod("annotationType", classArray);
    }

    public Until$Proxy(InvocationHandler invocationHandler) {
