...
public class SerializedName$Proxy
extends Proxy
implements SerializedName {
    ...
    static {
        ...
        method$0 = SerializedName.class.getMethod("value", classArray);
        ...
        classArray = new Class[]{};
        method$4 = SerializedName$Proxy.class.getMethod("annotationType", classArray);
    }

    public SerializedName$Proxy(InvocationHandler invocationHandler) {
