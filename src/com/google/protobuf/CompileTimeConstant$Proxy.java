...
public class CompileTimeConstant$Proxy
extends Proxy
implements CompileTimeConstant {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = CompileTimeConstant$Proxy.class.getMethod("annotationType", classArray);
    }

    public CompileTimeConstant$Proxy(InvocationHandler invocationHandler) {
