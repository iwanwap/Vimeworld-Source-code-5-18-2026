...
extends ByteString {
    ...
    private boolean equalsFragments(ByteString other) {
        ...
        while (true) {
            ...
            boolean bl2 = stillEqual = thisOffset == 0 ? thisString.equalsRange(thatString, thatOffset, bytesToCompare) : thatString.equalsRange(thisString, thisOffset, bytesToCompare);
            if (!stillEqual) {
                return false;
            }
    ...
    extends InputStream {
        ...
        public int read(byte[] b2, int offset, int length) {
            ...
            int bytesRead = this.readSkipInternal(b2, offset, length);
