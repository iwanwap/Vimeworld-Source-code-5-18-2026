...
public class CanIgnoreReturnValue$Proxy
extends Proxy
implements CanIgnoreReturnValue {
    ...
    static {
        ...
        classArray = new Class[]{};
        method$3 = CanIgnoreReturnValue$Proxy.class.getMethod("annotationType", classArray);
    }

    public CanIgnoreReturnValue$Proxy(InvocationHandler invocationHandler) {
