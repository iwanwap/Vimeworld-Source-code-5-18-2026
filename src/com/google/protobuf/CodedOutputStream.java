...
extends ByteOutput {
    ...
    public static long encodeZigZag64(long n2) {
        return n2 << 1 ^ n2 >> 63;
    }
    ...
    extends AbstractBufferedEncoder {
        ...
        public void writeStringNoTag(String value) throws IOException {
            try {
                ...
                this.inefficientWriteStringNoTag(value, e4);
            }
        }
    ...
    extends CodedOutputStream {
        ...
        public final void write(byte value) throws IOException {
            ...
            try {
                ...
                throw new OutOfSpaceException(position, this.limit, 1, (Throwable)e2);
            }
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, 1, (Throwable)e2);
            }
        }
        ...
        public final void writeFixed32NoTag(int value) throws IOException {
            int position = this.position;
            try {
                this.buffer[position] = (byte)(value & 0xFF);
                this.buffer[position + 1] = (byte)(value >> 8 & 0xFF);
                this.buffer[position + 2] = (byte)(value >> 16 & 0xFF);
                this.buffer[position + 3] = (byte)(value >> 24 & 0xFF);
            }
            catch (IndexOutOfBoundsException e2) {
                throw new OutOfSpaceException(position, this.limit, 4, (Throwable)e2);
            }
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            int position = this.position;
            try {
                this.buffer[position] = (byte)((int)value & 0xFF);
                this.buffer[position + 1] = (byte)((int)(value >> 8) & 0xFF);
                this.buffer[position + 2] = (byte)((int)(value >> 16) & 0xFF);
                this.buffer[position + 3] = (byte)((int)(value >> 24) & 0xFF);
                this.buffer[position + 4] = (byte)((int)(value >> 32) & 0xFF);
                this.buffer[position + 5] = (byte)((int)(value >> 40) & 0xFF);
                this.buffer[position + 6] = (byte)((int)(value >> 48) & 0xFF);
                this.buffer[position + 7] = (byte)((int)(value >> 56) & 0xFF);
            }
            catch (IndexOutOfBoundsException e2) {
                throw new OutOfSpaceException(position, this.limit, 8, (Throwable)e2);
            }
        ...
        public final void writeStringNoTag(String value) throws IOException {
            ...
            try {
                ...
                this.position = oldPosition;
                this.inefficientWriteStringNoTag(value, e2);
            }
    ...
    extends CodedOutputStream {
        ...
        public void writeFixed32NoTag(int value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, 4, (Throwable)e2);
            }
            this.position += 4L;
        }
        ...
        public void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, 8, (Throwable)e2);
            }
            this.position += 8L;
        }
