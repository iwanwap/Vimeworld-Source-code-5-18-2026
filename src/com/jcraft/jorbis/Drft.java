                    ...
                    for (int k1 = 0; k1 < nfm1; ++k1) {
                        ...
                        for (j2 = 0; j2 < ipm; is2 += ido, ++j2) {
                            ...
                            for (int ii2 = 2; ii2 < ido; ii2 += 2) {
                                float arg = (fi2 += 1.0f) * argld;
                                wa2[index + i2++] = (float)Math.cos(arg);
                                wa2[index + i2++] = (float)Math.sin(arg);
                            }
                        }
                        l1 = l2;
                    }
...
lbl258:
     ...
     * Enabled aggressive block sorting
     */
    static void drftf1(int n2, float[] c2, float[] ch2, float[] wa2, int[] ifac) {
        int nf2 = ifac[1];
        int na2 = 1;
        int l2 = n2;
        int iw2 = n2;
            ...
            block10: while (true) {
                switch (state) {
                    case 100: {
                        ...
                        int ix3 = ix2 + ido;
                        if (na2 != 0) {
                            Drft.dradf4(ido, l1, ch2, c2, wa2, iw2 - 1, wa2, ix2 - 1, wa2, ix3 - 1);
                        } else {
                            Drft.dradf4(ido, l1, c2, ch2, wa2, iw2 - 1, wa2, ix2 - 1, wa2, ix3 - 1);
                        }
                        state = 110;
                        break;
                    }
                    case 102: {
                        ...
                        Drft.dradf2(ido, l1, c2, ch2, wa2, iw2 - 1);
                        state = 110;
                        break;
                    }
                    case 103: {
                        Drft.dradf2(ido, l1, ch2, c2, wa2, iw2 - 1);
                    }
                    case 104: {
                        if (ido == 1) {
                            na2 = 1 - na2;
                        ...
                        Drft.dradfg(ido, ip2, l1, idl1, c2, c2, c2, ch2, ch2, wa2, iw2 - 1);
                        na2 = 1;
                        state = 110;
                        break;
                    }
                    case 109: {
                        Drft.dradfg(ido, ip2, l1, idl1, ch2, ch2, ch2, c2, c2, wa2, iw2 - 1);
                        na2 = 0;
                    }
                    case 110: {
                        l2 = l1;
    ...
    static void dradb3(int ido, int l1, float[] cc2, float[] ch2, float[] wa1, int index1, float[] wa2, int index2) {
        ...
        for (k2 = 0; k2 < l1; ++k2) {
            ...
            for (int i2 = 2; i2 < ido; i2 += 2) {
                ...
                float di2 = ci2 + cr3;
                float di3 = ci2 - cr3;
                ch2[t9 - 1] = wa1[index1 + i2 - 2] * dr2 - wa1[index1 + i2 - 1] * di2;
                ch2[t9] = wa1[index1 + i2 - 2] * di2 + wa1[index1 + i2 - 1] * dr2;
                ch2[t10 - 1] = wa2[index2 + i2 - 2] * dr3 - wa2[index2 + i2 - 1] * di3;
...
lbl283:
     ...
     * Enabled aggressive block sorting
     */
    static void drftb1(int n2, float[] c2, float[] ch2, float[] wa2, int index, int[] ifac) {
        int l2 = 0;
        int ip2 = 0;
        int ido = 0;
        int idl1 = 0;
            ...
            block9: while (true) {
                switch (state) {
                    case 100: {
                        ...
                        int ix3 = ix2 + ido;
                        if (na2 != 0) {
                            Drft.dradb4(ido, l1, ch2, c2, wa2, index + iw2 - 1, wa2, index + ix2 - 1, wa2, index + ix3 - 1);
                        } else {
                            Drft.dradb4(ido, l1, c2, ch2, wa2, index + iw2 - 1, wa2, index + ix2 - 1, wa2, index + ix3 - 1);
                        }
                        na2 = 1 - na2;
                        state = 115;
                        break;
                    ...
                    case 103: {
                        ...
                        if (na2 != 0) {
                            Drft.dradb2(ido, l1, ch2, c2, wa2, index + iw2 - 1);
                        } else {
                            Drft.dradb2(ido, l1, c2, ch2, wa2, index + iw2 - 1);
                        }
                        na2 = 1 - na2;
                        state = 115;
                        break;
                    ...
                    case 106: {
                        ...
                        int ix2 = iw2 + ido;
                        if (na2 != 0) {
                            Drft.dradb3(ido, l1, ch2, c2, wa2, index + iw2 - 1, wa2, index + ix2 - 1);
                        } else {
                            Drft.dradb3(ido, l1, c2, ch2, wa2, index + iw2 - 1, wa2, index + ix2 - 1);
                        }
                        na2 = 1 - na2;
                        state = 115;
                        break;
                    ...
                    case 109: {
                        if (na2 != 0) {
                            Drft.dradbg(ido, ip2, l1, idl1, ch2, ch2, ch2, c2, c2, wa2, index + iw2 - 1);
                        } else {
                            Drft.dradbg(ido, ip2, l1, idl1, c2, c2, c2, ch2, ch2, wa2, index + iw2 - 1);
                        }
                        if (ido == 1) {
                            na2 = 1 - na2;
                        }
