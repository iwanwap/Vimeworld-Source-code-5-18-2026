...
public class RealmsOptions {
    ...
    public String getSlotName(int i2) {
        if (this.slotName == null || this.slotName.equals("")) {
            if (this.empty) {
                return RealmsScreen.getLocalizedString((String)"mco.configure.world.slot.empty");
            }
            return RealmsScreen.getLocalizedString((String)"mco.configure.world.slot", (Object[])new Object[]{i2});
        }
