...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.agreeButton = RealmsTermsScreen.newButton((int)1, (int)column1_x, (int)RealmsConstants.row(12), (int)column_width, (int)20, (String)RealmsTermsScreen.getLocalizedString((String)"mco.terms.buttons.agree"));
        this.buttonsAdd(this.agreeButton);
        this.buttonsAdd(RealmsTermsScreen.newButton((int)2, (int)column2_x, (int)RealmsConstants.row(12), (int)column_width, (int)20, (String)RealmsTermsScreen.getLocalizedString((String)"mco.terms.buttons.disagree")));
    }
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        this.drawCenteredString(RealmsTermsScreen.getLocalizedString((String)"mco.terms.title"), this.width() / 2, 17, 0xFFFFFF);
        this.drawString(RealmsTermsScreen.getLocalizedString((String)"mco.terms.sentence.1"), this.width() / 2 - 120, RealmsConstants.row(5), 0xFFFFFF);
        int firstPartWidth = this.fontWidth(RealmsTermsScreen.getLocalizedString((String)"mco.terms.sentence.1"));
        ...
        if (x1 <= xm2 && xm2 <= x2 && y1 <= ym2 && ym2 <= y2) {
            this.onLink = true;
            this.drawString(" " + RealmsTermsScreen.getLocalizedString((String)"mco.terms.sentence.2"), this.width() / 2 - 120 + firstPartWidth, RealmsConstants.row(5), 7107012);
        } else {
            this.onLink = false;
            this.drawString(" " + RealmsTermsScreen.getLocalizedString((String)"mco.terms.sentence.2"), this.width() / 2 - 120 + firstPartWidth, RealmsConstants.row(5), 0x3366BB);
        }
