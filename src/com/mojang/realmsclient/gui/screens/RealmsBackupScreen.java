...
extends RealmsScreen {
    ...
    private void postInit() {
        this.downloadButton = RealmsBackupScreen.newButton((int)2, (int)(this.width() - 125), (int)32, (int)100, (int)20, (String)RealmsBackupScreen.getLocalizedString((String)"mco.backup.button.download"));
        this.buttonsAdd(this.downloadButton);
        this.buttonsAdd(RealmsBackupScreen.newButton((int)0, (int)(this.width() - 125), (int)(this.height() - 35), (int)85, (int)20, (String)RealmsBackupScreen.getLocalizedString((String)"gui.back")));
    }
    ...
    private void restoreClicked(int selectedBackup) {
        if (selectedBackup >= 0 && selectedBackup < this.backups.size() && !this.serverData.expired) {
            ...
            String line2 = RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.restore.question.line1", (Object[])new Object[]{datePresentation, age});
            String line3 = RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.restore.question.line2");
    ...
    private void downloadClicked() {
        String line2 = RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.restore.download.question.line1");
        String line3 = RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.restore.download.question.line2");
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        this.drawCenteredString(RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.backup"), this.width() / 2, 12, 0xFFFFFF);
        this.drawString(RealmsBackupScreen.getLocalizedString((String)"mco.configure.world.backup"), (this.width() - 150) / 2 - 90, 20, 0xA0A0A0);
        if (this.noBackups.booleanValue()) {
            this.drawString(RealmsBackupScreen.getLocalizedString((String)"mco.backup.nobackups"), 20, this.height() / 2 - 10, 0xFFFFFF);
        }
    ...
    extends RealmsClickableScrolledSelectionList {
        ...
        public void itemClicked(int clickSlotPos, int slot, int xm2, int ym2, int width) {
            ...
            if (xm2 >= infox && xm2 <= infox + 9 && ym2 >= infoy && ym2 <= infoy + 9) {
                if (!((Backup)((RealmsBackupScreen)RealmsBackupScreen.this).backups.get((int)slot)).changeList.isEmpty()) {
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsBackupInfoScreen(RealmsBackupScreen.this, (Backup)RealmsBackupScreen.this.backups.get(slot)));
                }
        ...
        private void drawRestore(int x2, int y2, int xm2, int ym2) {
            ...
            RealmsScreen.bind((String)RealmsBackupScreen.RESTORE_ICON_LOCATION);
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            GL11.glPushMatrix();
            GL11.glScalef(0.5f, 0.5f, 0.5f);
            RealmsScreen.blit((int)(x2 * 2), (int)(y2 * 2), (float)0.0f, (float)(hovered ? 28.0f : 0.0f), (int)23, (int)28, (float)23.0f, (float)56.0f);
            GL11.glPopMatrix();
            if (hovered) {
                RealmsBackupScreen.this.toolTip = RealmsScreen.getLocalizedString((String)"mco.backup.button.restore");
            }
        }
        ...
        private void drawInfo(int x2, int y2, int xm2, int ym2) {
            ...
            RealmsScreen.bind((String)RealmsBackupScreen.PLUS_ICON_LOCATION);
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            GL11.glPushMatrix();
            GL11.glScalef(0.5f, 0.5f, 0.5f);
            RealmsScreen.blit((int)(x2 * 2), (int)(y2 * 2), (float)0.0f, (float)(hovered ? 15.0f : 0.0f), (int)15, (int)15, (float)15.0f, (float)30.0f);
            GL11.glPopMatrix();
            if (hovered) {
                RealmsBackupScreen.this.toolTip = RealmsScreen.getLocalizedString((String)"mco.backup.changes.tooltip");
            }
        }
    }
    ...
    extends LongRunningTask {
        ...
        @Override
        public void run() {
            this.setTitle(RealmsScreen.getLocalizedString((String)"mco.backup.restoring"));
            for (int i2 = 0; i2 < 6; ++i2) {
                try {
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e3, (RealmsScreen)RealmsBackupScreen.this.lastScreen));
                    return;
                }
                catch (Exception e4) {
                    if (this.aborted()) {
