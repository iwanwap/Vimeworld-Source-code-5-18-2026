...
extends RealmsScreenWithCallback<WorldTemplate> {
    ...
    public void init() {
        ...
        this.buttonsClear();
        this.playersButton = RealmsConfigureWorldScreen.newButton((int)2, (int)this.centerButton(0, 3), (int)RealmsConstants.row(0), (int)this.default_button_width, (int)20, (String)RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.buttons.players"));
        this.buttonsAdd(this.playersButton);
        this.settingsButton = RealmsConfigureWorldScreen.newButton((int)3, (int)this.centerButton(1, 3), (int)RealmsConstants.row(0), (int)this.default_button_width, (int)20, (String)RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.buttons.settings"));
        this.buttonsAdd(this.settingsButton);
        this.subscriptionButton = RealmsConfigureWorldScreen.newButton((int)4, (int)this.centerButton(2, 3), (int)RealmsConstants.row(0), (int)this.default_button_width, (int)20, (String)RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.buttons.subscription"));
        this.buttonsAdd(this.subscriptionButton);
        this.optionsButton = new RealmsHideableButton(5, this.leftButton(0), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.buttons.options"));
        this.buttonsAdd(this.optionsButton);
        this.backupButton = new RealmsHideableButton(6, this.leftButton(1), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.backup"));
        this.buttonsAdd(this.backupButton);
        this.resetWorldButton = new RealmsHideableButton(7, this.leftButton(2), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.buttons.resetworld"));
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        this.drawCenteredString(RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.title"), this.width() / 2 - nameWidth / 2 - 2, 17, 0xFFFFFF);
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e2.getMessage(), RealmsConfigureWorldScreen.this.lastScreen));
                }
    ...
    private void drawSlotFrame(int x2, int y2, int xm2, int ym2, boolean active, String text, int i2, long imageId, String image, boolean empty) {
        if (xm2 >= x2 && xm2 <= x2 + 80 && ym2 >= y2 && ym2 <= y2 + 80 && (!this.isMinigame() && this.serverData.activeSlot != i2 || this.isMinigame() && i2 != 4) && (i2 != 4 || !this.serverData.expired)) {
            this.hoveredSlot = i2;
            String string = this.toolTip = i2 == 4 ? RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.slot.tooltip.minigame") : RealmsConfigureWorldScreen.getLocalizedString((String)"mco.configure.world.slot.tooltip");
        }
        ...
        if (!active) {
            ...
            float c2 = 0.9f + 0.1f * RealmsMth.cos((float)((float)this.animTick * 0.2f));
            GL11.glColor4f(c2, c2, c2, 1.0f);
        }
        RealmsScreen.blit((int)(x2 + 3), (int)(y2 + 3), (float)0.0f, (float)0.0f, (int)74, (int)74, (float)74.0f, (float)74.0f);
        ...
        RealmsScreen.blit((int)x2, (int)y2, (float)0.0f, (float)0.0f, (int)80, (int)80, (float)80.0f, (float)80.0f);
    ...
    public void saveSlotSettings() {
        ...
        try {
            ...
            Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e2, (RealmsScreen)this));
            return;
        }
