...
extends RealmsScreenWithCallback<WorldTemplate> {
    ...
    private String title = RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.title");
    private String subtitle = RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.warning");
    private String buttonTitle = RealmsResetWorldScreen.getLocalizedString((String)"gui.cancel");
    ...
    public void init() {
        this.buttonsClear();
        this.buttonsAdd(RealmsResetWorldScreen.newButton((int)0, (int)(this.width() / 2 - 40), (int)(RealmsConstants.row(14) - 10), (int)80, (int)20, (String)this.buttonTitle));
        if (!this.loaded) {
    ...
    public void mouseClicked(int x2, int y2, int buttonNum) {
        switch (this.selectedType) {
            ...
            case ADVENTURE: {
                ...
                screen.setTitle(RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.adventure"));
            ...
            case SURVIVAL_SPAWN: {
                ...
                templateScreen.setTitle(RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.template"));
    ...
    public void render(int xm2, int ym2, float a2) {
        ...
        if (this.loaded) {
            this.drawFrame(this.frame(1), RealmsConstants.row(0) + 10, xm2, ym2, RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.generate"), -1L, "textures/gui/title/background/panorama_3.png", ResetType.GENERATE);
            this.drawFrame(this.frame(2), RealmsConstants.row(0) + 10, xm2, ym2, RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.upload"), -1L, UPLOAD_LOCATION, ResetType.UPLOAD);
            this.drawFrame(this.frame(1), RealmsConstants.row(6) + 20, xm2, ym2, RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.adventure"), Long.valueOf(this.adventuremaps.get((int)this.adventureMapId).id), this.adventuremaps.get((int)this.adventureMapId).image, ResetType.ADVENTURE);
            this.drawFrame(this.frame(2), RealmsConstants.row(6) + 20, xm2, ym2, RealmsResetWorldScreen.getLocalizedString((String)"mco.reset.world.template"), Long.valueOf(this.templates.get((int)this.templateId).id), this.templates.get((int)this.templateId).image, ResetType.SURVIVAL_SPAWN);
        }
    ...
    private void drawFrame(int x2, int y2, int xm2, int ym2, String text, long imageId, String image, ResetType resetType) {
        ...
        if (imageId != -1L) {
            ...
            RealmsResetWorldScreen.bind((String)image);
        }
        if (hovered) {
        ...
        RealmsScreen.blit((int)(x2 + 2), (int)(y2 + 2), (float)0.0f, (float)0.0f, (int)56, (int)56, (float)56.0f, (float)56.0f);
        RealmsResetWorldScreen.bind((String)SLOT_FRAME_LOCATION);
        if (hovered) {
            GL11.glColor4f(0.56f, 0.56f, 0.56f, 1.0f);
        } else {
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        }
        RealmsScreen.blit((int)x2, (int)y2, (float)0.0f, (float)0.0f, (int)60, (int)60, (float)60.0f, (float)60.0f);
    ...
    public void confirmResult(boolean result, int id2) {
        ...
        if (result) {
            Realms.setScreen((RealmsScreen)this.returnScreen);
        }
    }
